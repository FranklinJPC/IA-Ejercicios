...
imagen_con_rostro1 = face_recognition.load_image_file("C:/Users/FUNDAMENTOS DE IA/Documents/IA/Examen Final/alexis.jpg")
imagen_con_rostro2 = face_recognition.load_image_file("C:/Users/FUNDAMENTOS DE IA/Documents/IA/Examen Final/franklin.jpg")
...
while True:
    ...
    for coordenada in coordenadas_rostro:   
        ...
        if resultado1[0]:
            cv2.putText(frame, "Alexis", (coordenada[3], coordenada[0] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
        elif resultado2[0]:
            cv2.putText(frame, "Franklin", (coordenada[3], coordenada[0] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
        else:
